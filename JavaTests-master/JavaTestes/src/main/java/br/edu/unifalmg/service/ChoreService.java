...
import br.edu.unifalmg.exception.EmptChoreListException;
...
public class ChoreService {
    ...
    public void deleteChore(String description, LocalDate deadLine){
        if(this.chores.isEmpty()){
            throw new EmptChoreListException("Unable to remove a chore from an empty list");
        }
        this.chores.stream().anyMatch()
    }
